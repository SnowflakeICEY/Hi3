...
public class SwordsViewActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_swords_view);
        ...
        String resName = "r" + intent.getIntExtra("mRareName", 0) + "tk" + intent.getIntExtra("mSwordsName", 0) ;
        Log.i("name", resName);
