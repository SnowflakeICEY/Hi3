...
public class GreatswordsViewActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_greatswords_view);
        ...
        String resName = "r" + intent.getIntExtra("mRareName", 0) + "ts" + intent.getIntExtra("mGreatswordsName", 0) ;
        Log.i("name", resName);
