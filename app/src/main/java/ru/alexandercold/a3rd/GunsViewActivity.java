...
public class GunsViewActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guns_view);
        ...
        String resName = "r" + intent.getIntExtra("mRareName", 0) + "tg" + intent.getIntExtra("mGunsName", 0) ;
        Log.i("name", resName);
