...
public class CrossesViewActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_crosses_view);
        ...
        String resName = "r" + intent.getIntExtra("mRareName", 0) + "tcr" + intent.getIntExtra("mCrossesName", 0) ;
        Log.i("name", resName);
