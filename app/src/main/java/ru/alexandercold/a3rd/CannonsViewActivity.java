...
public class CannonsViewActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cannons_view);
        ...
        String resName = "r" + intent.getIntExtra("mRareName", 0) + "tc" + intent.getIntExtra("mCannonsName", 0) ;
        Log.i("name", resName);
